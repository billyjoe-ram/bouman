...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-6">
            <center><h1> <?php echo $texto?></h1></center>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4" id="texto">
            ...
            <p>Pensando no senso de comunidade, oferecemos a opção dos <span class="destaque">usuários contribuirem</span> em trabalhos de outros pesquisadores, 
            oferecendo sugestões e análises.  Também, visando o investimento nestes projetos, temos uma interface amigável e <span class="destaque">compatível 
            com empresas</span> que buscam novos talentos e querem se conectar com os profissionais.</p>
            <p>Infelzmente não podemos fazer isso, <span class="destaque">sem a sua ajuda</span>! Nossos usuários são nossa maior prioridade e queremos que eles 
            ...
            ao lado se você tem interesse de receber nossos <span class="destaque">Termos de Uso</span> previamente e ser um dos primeiros a explorar a plataforma!</p>
        </div>
        <div class="col-md-1"></div>
        <div class="col-md-5">
            <form class="precadastro" name="precadastro" method="post">
                ...
                <div class="row">
                    <div class="col">
                        <label>Celular</label>
                        <input type="tel" name="txtcelular" id="celular" minlength="11" maxlength="11" required data-js="celu"/>
                    </div>
                    <div class="col">
                        <label>Telefone</label>
                        <input type="tel" name="txttelefone" id="telefone" minlength="10" maxlength="10" data-js="tele"/>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
